...
<fieldset>
    ...
    <form action="#/" method="post">
        ...
        <input type="text" id="username" name="user.userName" value="${currentUser.userName}" readonly/>
        <label for="pass">密码:</label>
        <input type="password" id="pass" name="user.userPassword" value="${currentUser.userPassword}"/>
